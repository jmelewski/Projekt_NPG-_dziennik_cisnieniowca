...
class Dziennik_Cisnieniowca_Aplikacja:
    def __init__(self, master):
        ...
        self.add_button = tk.Button(self.main_frame, text="Szukaj pomiaru", command=self,
                                    font=FONT, bg=BUTTON_COLOR, fg=TEXT_COLOR)
        self.add_button.pack(pady=10)

        self.add_button = tk.Button(self.main_frame, text="Zmien ścieżkę zapisu", command=self,
                                    font=FONT, bg=BUTTON_COLOR, fg=TEXT_COLOR)
        self.add_button.pack(pady=10)

        self.add_button = tk.Button(self.main_frame, text="Utwórz wykres pomiarów", command=self,
                                    font=FONT, bg=BUTTON_COLOR, fg=TEXT_COLOR)
        self.add_button.pack(pady=10)
